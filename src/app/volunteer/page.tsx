...
export default function VolunteerPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-10 max-w-md">
      ...
      {submitted ? (
        <p className="text-green-400">Thank you for volunteering! We'll reach out soon.</p>
      ) : (
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <textarea placeholder="Why do you want to volunteer?" className="w-full p-2 bg-gray-800 text-white rounded" rows={4} required />
